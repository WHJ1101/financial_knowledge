...
import { localDate as formatLocalDate, localDateTime as formatLocalDateTime, DEFAULT_TIME_ZONE } from "./datetime.js";
...
async function fetchJson(url, { fetchImpl }) {
  const response = await fetchWithTimeout(url, { fetchImpl, timeout: HTTP_TIMEOUT_MS });
